...
describe("SubagentsPanel view-mode toggle", () => {
  ...
  it("switches to graph view when the graph button is clicked", () => {
    mockChildTree({
      conv_root: [
  ...
  it("switches back to list view when the list button is clicked", () => {
    mockChildTree({
  ...
  it("passes conversationId and rootSessionId to the graph view", () => {
    mockChildTree({
      conv_root: [childInfo({ id: "c1", tool: "researcher" })],
    });
